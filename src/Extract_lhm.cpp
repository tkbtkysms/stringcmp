...
Extract_lhm::Extract_lhm()
{
    result_size = 0;
}
void Extract_lhm::CalcMilnor(Initialdata Id, Rule rule1, int newnumExtract, int order1, int lnum)
{
    prun_size = 0;
    order = order1;
...
void Extract_lhm::sub(Initialdata Id1, Initialdata Id2, Rule rule1, Rule rule2, int newnumExtract, int order1, int lnum1, int lnum2)
{
...
Polynomial_lhm Extract_lhm::Decompose(Initialdata Id, Rule rule, int newnumExtract, int lnum)
{
    longitude lf;
...
void Extract_lhm::monotopoly(int depth, int segment, int string_num, int lnum)
{
    std::string term;
    int string_num_abs;
...
void Extract_lhm::recursiveDecompose(Rule rule, uint recursivenum, int lnum)
{
...
void Extract_lhm::expandFomula(int size, int extractid)
{
...
void Extract_lhm::Calculate(Rule rule, int recursivenum, int front)
{
